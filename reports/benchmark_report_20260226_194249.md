...
**Generated**: 2026-02-26 19:42:49
**Result**: **9/11** benchmarks passed
**Total Runtime**: 10.2s
...
| 2 | 1.4 Mixed REE/Fe/Al in Chloride Media | Speciation | ❌ FAIL | 0.2 |
| 3 | 3.2 REE Recovery vs Published Plant Data | Process Balance | ❌ FAIL | 1.4 |
| 4 | 3.3 Reagent Consumption Scaling | Process Balance | ✅ PASS | 0.7 |
| 5 | 4.1 OPEX $/kg REO vs Published | TEA/LCA | ✅ PASS | 1.5 |
...
| 9 | 6.2 Single-Unit Flowsheet | Robustness | ✅ PASS | 0.3 |
...
**Details**:
> Exception: [1;31m***ERROR***
Could not find a species with name or index `FeCl3(aq)` in the chemical system.
[0m
...
**Details**:
> SX recovery=0.1% (analytical=88.2%), Precip recovery=100.0%, Overall=100.0%. Out of range.
